...
internal static class RelationsDrawerUtils
{
	internal static ItemMember[] CreateItemMembers(Type drawerType, Type relationType, Type keyType)
	{
		Type genericDrawerType = drawerType.MakeGenericType(relationType, keyType);
		MemberPath[] typeMembers = ItemUtils.GetTypeMembers(relationType);
