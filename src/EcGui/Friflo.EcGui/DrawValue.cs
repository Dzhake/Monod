...
public readonly struct DrawValue
{
	...
	{
		if ((object)memberDrawer.member.setter == null)
		{
			return false;
		}
		context.Edit();
	...
	public ItemFlags DrawException(Exception exception)
	{
		...
		{
			ImGui.SetClipboardText(TextUtils.AsSpan(ExceptionUtils.GetExceptionDetails(exception, memberDrawer.member, Entity)));
		}
		...
		if (ImGui.IsItemHovered(ImGuiHoveredFlags.ForTooltip))
		{
			...
			ImGui.SetItemTooltip(TextUtils.AsSpan(exceptionDetails));
		}
		return result;
	}
}
