...
internal sealed class MemberField : IMember
{
    ...
    public void DrawMemberNode(DrawNode drawNode)
    {
        ...
        if (num)
        {
            ...
            expandField = ImGui.TreeNodeEx(fieldDrawer.label, ImGuiTreeNodeFlags.AllowOverlap | ImGuiTreeNodeFlags.FramePadding | ImGuiTreeNodeFlags.SpanLabelWidth | ImGuiTreeNodeFlags.LabelSpanAllColumns);
            ImGui.PopItemFlag();
        }
        else
        {
            ...
            expandField = ImGui.TreeNodeEx(fieldDrawer.label, ImGuiTreeNodeFlags.AllowOverlap | ImGuiTreeNodeFlags.Leaf | ImGuiTreeNodeFlags.FramePadding | ImGuiTreeNodeFlags.SpanLabelWidth | ImGuiTreeNodeFlags.LabelSpanAllColumns);
            ImGui.PopItemFlag();
        }
        ...
        var drawValue = new DrawValue(context, in fieldDrawer, DrawValueFlags.Value);
        fieldDrawer.typeDrawer.DrawValue(in drawValue);
        if (EntityInspector.MorePopup("field_more", out bool _))
        {
