...
public sealed class AssetManager : IDisposable
{
    ...
    /// <summary>
    /// Whether this <see cref="AssetManager"/> can reload assets (<see cref="CanReload"/>) and <see cref="MonodSettings.HotReload"/> is on.
    /// </summary>
    ...
    public T Get<T>(string path)
    {
        ...
        switch (asset)
        {
            ...
            default:
                //does not return
                AssetTypeMismatchException.Throw(this, path, typeof(T), asset.GetType());
                return default;
        }
    }
