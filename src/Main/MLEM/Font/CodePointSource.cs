...
namespace MLEM.Font {
    ...
    public readonly struct CodePointSource : IEnumerable<int> {
        ...
        /// <returns>A <see cref="TEnum:System.Collections.Generic.IEnumerator`1" /> that can be used to iterate through the collection.</returns>
        ...
        /// <returns>An <see cref="TEnum:System.Collections.IEnumerator" /> object that can be used to iterate through the collection.</returns>
